...
export const RESOURCES_SCENE_A = [
...
export const RESOURCES_SCENE_B = [
    { name: 'SCENE_B', src: SCENE_B, type: 'gltf' },
    { name: 'SCENE_BACK', src: SCENE_BACK, type: 'gltf' },
    { name: 'HDR_SKIES', src: HDR_SKIES },
];
export const RESOURCES_SCENE_C = [
    { name: 'SCENE_C', src: SCENE_C, type: 'gltf' },
    { name: 'SCENE_BACK', src: SCENE_BACK, type: 'gltf' },
    { name: 'HDR_SKIES', src: HDR_SKIES },
];
export const RESOURCES_SCENE_D = [
    { name: 'SCENE_D', src: SCENE_D, type: 'gltf' },
    { name: 'SCENE_BACK', src: SCENE_BACK, type: 'gltf' },
    { name: 'HDR_SKIES', src: HDR_SKIES },
];
export const RESOURCES_SCENE_E = [
    { name: 'SCENE_E', src: SCENE_E, type: 'gltf' },
    { name: 'SCENE_BACK', src: SCENE_BACK, type: 'gltf' },
    { name: 'HDR_SKIES', src: HDR_SKIES },
];
export const RESOURCES_SCENE_LOAD = [
    { name: 'LOGO', src: MODEL_BNSV },
    { name: 'HDR_SKIES', src: HDR_SKIES },
];
export const RESOURCES_SCENE_ALL = [
...
export const RESOURCES_DEVICE_ALL = [
...
//# sourceMappingURL=resource_regist.js.map