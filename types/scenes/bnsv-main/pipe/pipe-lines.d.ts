...
export declare class PipeLines {
    ...
    /**最下侧管道 */
    readonly part1: PipePart1;
    /**水箱+管道03部分管道 */
    readonly part2: PipePart2;
    /**水箱+管道04部分管道 */
    readonly part3: PipePart3;
    /**水锤消除管部分+上方部分 */
    readonly part4: PipePart4;
    /**主水泵管道部分 */
    readonly part5: PipePart5;
    /**最上侧管道 */
    readonly part6: PipePart6;
    /**外部+室外消除罐部分管道 */
    readonly part7: PipePart7;
    /**格局设备状态设置数组数据
