import { Color, DoubleSide, IUniform, Material, MeshStandardMaterial, ShaderMaterial, Uniform, Vector3, WebGLProgramParametersWithUniforms, WebGLRenderer } from "three"
